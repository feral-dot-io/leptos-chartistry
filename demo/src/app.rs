        ...
        <Router>
            ...
            <main>
                <Routes fallback=NotFound>
                    <Route path=(StaticSegment("leptos-chartistry"), StaticSegment("")) view=Demo />
                    <Route path=(StaticSegment("leptos-chartistry"), StaticSegment("examples.html")) view=Examples />
                    <ParentRoute path=(StaticSegment("leptos-chartistry"), StaticSegment("examples")) view=|| view!(<Outlet />)>
